...
class Review(BaseModel):
    ...
    positive: Optional[list[str]] = Field(default=None, description="A list of positive aspects of the review, if any.")
    negative: Optional[list[str]] = Field(default=None, description="A list of negative aspects of the review, if any.")
    reviewer: Optional[str] = Field(
        default=None, description="The name of the reviewer if written by a specific person. Don't include if not specified or anonymous."
    )
...
with open("structured_output/review_result_pydantic.json", "w") as f:
